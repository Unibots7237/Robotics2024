...
public class DriveSubsystem extends SubsystemBase {
  ...
  public double getGyroOnInterval(double degree) {
    return -Math.IEEEremainder(degree, 360);
  }
  ...
  public double getDistanceToTarget(String targetType){
    switch (targetType){
      case "Amp":
        distanceToTarget = ((AutoConstants.ampTagHeightInches - AutoConstants.limelightHeight) / (Math.tan(LimelightHelpers.getTY("limelight")+AutoConstants.limelightAngle)));
      case "Speaker":
        distanceToTarget = ((AutoConstants.speakerTagHeightInches - AutoConstants.limelightHeight) / (Math.tan(LimelightHelpers.getTY("limelight")+AutoConstants.limelightAngle)));
    }
